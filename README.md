...
Backend Update Center 2.1 offers a `-javaVersion [version]` CLI argument
which can be used to filter plugins based on their minimum Java version requirement.
