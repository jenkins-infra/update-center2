...
wget -O generator.zip "https://repo.jenkins-ci.org/snapshots/org/jenkins-ci/update-center2/3.0-SNAPSHOT/update-center2-3.0-20200428.100041-13-bin.zip"
...
generate -skip-release-history -skip-plugin-versions -www "$WWW_ROOT_DIR/experimental"
...
# fastjson cannot handle a file.encoding of US-ASCII, so set a sane default here
